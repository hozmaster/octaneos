...
static inline void __generic_memcpy_tofs(void * to, 
...
static inline void __constant_memcpy_tofs(void *to, 
										  const void *from, unsigned long n) {
	switch (n) {
		case 0:
			return;
	...
	// TODO: fatal bug, removed common code

}

static inline void __generic_memcpy_fromfs(void *to, 
										   const void *from, unsigned long n) {
__asm__("cld\n\t"
		"cmpl $3,%0\n\t"
		"jbe 1f\n\t"
